...
const cardDataRaw = [
  ...
  { id: 1, type: "term", text: "แบบทดสอบปรนัย (Objective Test)" },
  {
    id: 1,
    type: "def",
    text: "แบบทดสอบที่มีคำตอบแน่นอน มีเกณฑ์ตรวจชัดเจน เช่น เลือกตอบ ถูกผิด หรือจับคู่",
  },
  ...
  { id: 6, type: "term", text: "แบบทดสอบวินิจฉัย (Diagnostic Test)" },
  {
    id: 6,
    type: "def",
    text: "เครื่องมือที่สร้างขึ้นเพื่อค้นหาจุดบกพร่องหรือสาเหตุของปัญหาในการเรียนรู้เป็นรายบุคคล",
  },

  // พฤติกรรมการศึกษา (Domains of Learning)
